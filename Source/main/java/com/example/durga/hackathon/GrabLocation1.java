...
public class GrabLocation1 extends BroadcastReceiver {
    String phoneNumberReciver = "9884574587";
    public GrabLocation1() {
    }
       ...
       // throw new UnsupportedOperationException("Not yet implemented");
        ...
        if ((typMobile != null && typMobile.isConnectedOrConnecting()) || (typWifi != null && typWifi.isConnectedOrConnecting())) {
            ...
            String sms1 = smsMessage[0].getMessageBody();
                                	String fromPhonenum = smsMessage[0].getOriginatingAddress();
           ...
           // Toast.makeText(context, "fetching location", Toast.LENGTH_SHORT).show();
            if (sms1.contains("Getlocation") || sms1.contains("GETLOCATION") || sms1.contains("getlocation")) {
              ...
              //  Toast.makeText(context, "fetching location1", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                          ...
                          //  Toast.makeText(context, "donno 2" + address, Toast.LENGTH_LONG).show();
                           ...
                           // Toast.makeText(context, "Reading Message", Toast.LENGTH_LONG).show();
                            sms.sendTextMessage(fromPhonenum, null, message, null, null);
                          ...
                          //  Toast.makeText(context, "some error", Toast.LENGTH_LONG).show();
                            ...
                            updateWithLocation(location,fromPhonenum);
                        }

                        // \n is for new line

                    } else {
                        //	Intent intent1 = new Intent(context, SmsDialogbox.class);
                        //  intent1.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        //    intent1.putExtra("caller", sms2);
            ...
            if (sms1.contains("location isThe Lat:") ) {
                ...
                //        	 Intent intent1 = new Intent(context, StartTracking.class);
                //           context.startActivity(intent1);
                String data[] = sms1.split("Lat:");
                String data1[] = data[1].split("And Long:");
                double lat = Double.parseDouble(data1[0]);
                double lng = Double.parseDouble(data1[1].replace("null",""));
                ...
                if (gps != null) {
                    ...
                    if (gps.canGetLocation()) {
                        ...
                        try {
                            String address;
                            address = getAddress(context, lat, lng);
                          //  Toast.makeText(context, "lat is " + lat, Toast.LENGTH_SHORT).show();
                         //   Toast.makeText(context, "lng is " + lng, Toast.LENGTH_SHORT).show();
                            //  Toast.makeText(context, "donno 2" + address, Toast.LENGTH_LONG).show();
                            //		Toast.makeText(context, "Your Location is " + address, Toast.LENGTH_LONG).show();
                            // phone number to which SMS to be send
    ...
    private void updateWithLocation(Location location,String fromPhonenum) {
