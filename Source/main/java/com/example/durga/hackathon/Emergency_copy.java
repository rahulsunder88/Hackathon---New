...
public class Emergency_copy extends FragmentActivity implements OnMapReadyCallback {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                          ...
                          //  }
                            ...
                            Toast.makeText(getBaseContext(), "inside exception" , Toast.LENGTH_SHORT).show();
                            mMediaPlayer.stop();
                            mMediaPlayer.start();
                            mMediaPlayer.reset();
                            MediaPlayer mMediaPlayer = new MediaPlayer();
